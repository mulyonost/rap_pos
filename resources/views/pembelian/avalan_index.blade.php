    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border mb-2">
                <button onclick="addForm('{{ route('avalan.store') }}')" class="btn btn-success btn-flat"><i class="fa fa-plus-circle"></i>Tambah Avalan</button>
            </div>
...
@includeIf('pembelian.avalan_form')
@endsection
