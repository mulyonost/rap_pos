    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border mb-2">
                <button onclick="addForm('{{ route('kas.store') }}')" class="btn btn-success btn-flat"><i class="fa fa-plus-circle"></i>Tambah Pengeluaran Kas</button>
            </div>
...
<script>
    ...
    function addForm(url){
        ...
        $('#modal-form .modal-title').text('Form Pengeluaran Kas');
